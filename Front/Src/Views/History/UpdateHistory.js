    ...
    AsyncStorage.getItem('user')
      .then(value=>{console.log(JSON.parse(value));
        ...
        if(JSON.parse(value).type =='guardian'){
           ...
           axios.put(`http://192.168.1.60:8090/story/update/${JSON.parse(value).dementia.id}`,
           history,{headers:{ 
  ...
  function DeleteHistory(){
    ...
    .then(value=>{console.log(JSON.parse(value));
      ...
      if(JSON.parse(value).type =='guardian'){
         ...
         axios.delete(`http://192.168.1.60:8090/story/delete/${JSON.parse(value).dementia.id}`,
         {history:history })
         .then((res) => navigation.navigate("drawer"))
   }})
