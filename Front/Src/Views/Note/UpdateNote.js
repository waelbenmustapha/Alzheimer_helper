   ...
   function UpdateNote() {
    ...
    AsyncStorage.getItem('user')
      .then(value=>{console.log(JSON.parse(value));
        ...
        axios.put(`http://192.168.96.104:8090/pending-notes/edit-note/${JSON.parse(value).id}/${route.params.el.id}`,
        ...
        .then((res) => {
          ...
          navigation.navigate("CheckNotes")})
           ...
           axios.put(`http://192.168.96.104:8090/notes/edit-note/${route.params.el.id}`,
           {description: description, title: title, date: date })
