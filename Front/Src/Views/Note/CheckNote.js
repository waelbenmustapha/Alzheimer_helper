    ...
    AsyncStorage.getItem('user')
      .then(value => {
        ...
        if (JSON.parse(value).type == 'dementia') {
          axios.put(`http://192.168.1.60:8090/pending-notes/delete-note/${JSON.parse(value).id}/${route.params.el.id}`,
          )
            .then((res) => {
          ...
          axios.delete(`http://192.168.1.60:8090/notes/delete-note/${route.params.el.id}`,
          )
