     ...
     'body': 'Your dementia has delete a note'
      ...
      function deltenote() {
        ...
        .then(value=>{
          ...
          axios.post(`http://192.168.96.99:8090/pending-notes/delete-note/${route.params.el.id}`,
          )           
          .then((res) => {
            ...
            navigation.navigate("CheckNotes")})
             ...
             axios.delete(`http://192.168.96.99:8090/notes/delete-note/${route.params.el.id}`,
             )
