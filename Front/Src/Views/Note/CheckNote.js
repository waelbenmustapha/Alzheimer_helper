     ...
     'body': 'Your dementia has delete a note'
      ...
      function deltenote() {
        ...
        .then(value=>{
          ...
          axios.put(`http://172.16.17.177:8090/pending-notes/delete-note/${JSON.parse(value).id}/${route.params.el.id}`,
          )           
          .then((res) => {
            ...
            navigation.navigate("CheckNotes")})
             ...
             axios.delete(`http://172.16.17.177:8090/notes/delete-note/${route.params.el.id}`,
             )
