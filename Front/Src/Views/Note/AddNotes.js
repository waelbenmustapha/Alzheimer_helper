    ...
    AsyncStorage.getItem('user')
      .then(value => {
        ...
        if (JSON.parse(value).type == 'dementia') {
          axios.post(`http://192.168.122.104:8090/pending-notes/add-note/${JSON.parse(value).id}`,
          ...
          axios.post(`http://192.168.122.104:8090/notes/add-note/${JSON.parse(value).dementia.id}`,
            { description: description, title: title, date: date })
