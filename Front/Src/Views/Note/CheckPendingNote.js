...
const CheckPendingNote = ({ route, navigation }) => {
  ...
  { 
    axios.post(`http://192.168.1.15:8090/pending-notes/accept/${route.params.note.id}`)           
  .then((res) => {
  ...
  { 
    axios.post(`http://192.168.1.15:8090/pending-notes/deny/${route.params.note.id}`)           
  .then((res) => {
  ...
  { 
    axios.delete(`http://192.168.1.15:8090/pending-notes/delete-pending-note/${route.params.note.id}`)           
  .then((res) => {
