...
const CheckPendingNote = ({ route, navigation }) => {
  ...
  function AcceptPending() {
    axios.post(`http://192.168.122.104:8090/pending-notes/accept/${route.params.note.id}`)
      .then((res) => {
  ...
  { 
    axios.post(`http://192.168.122.104:8090/pending-notes/deny/${route.params.note.id}`)           
  .then((res) => {
  ...
  function DeletePending() {
    axios.delete(`http://192.168.122.104:8090/pending-notes/delete-pending-note/${route.params.note.id}`)
      .then((res) => {
