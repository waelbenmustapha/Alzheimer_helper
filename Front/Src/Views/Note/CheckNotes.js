...
const CheckNotes = ({ navigation }) => {
  ...
  function getData() {
    // axios
    //   .get(
    //     `http://192168.1.26:8090/notes/get-notes-by-dementia-id/`
    //   )
      ...
      .then(value=>{
        ...
        if(JSON.parse(value).type =='dementia'){
          axios.get(`http://192168.1.26:8090/notes/get-notes-by-dementia-id/${JSON.parse(value).id}`)
          .then((res) => 
        ...
        axios.get(`http://192168.1.26:8090/notes/get-notes-by-dementia-id/${JSON.parse(value).dementia.id}`)
