    ...
    AsyncStorage.getItem('user')
      .then(value => {
        ...
        if (JSON.parse(value).type == 'dementia') {
          axios.get(`http://https://alzhelper.herokuapp.com/notes/get-notes-by-dementia-id/${JSON.parse(value).id}`)
            .then((res) => {
          ...
          axios.get(`http://https://alzhelper.herokuapp.com/notes/get-notes-by-dementia-id/${JSON.parse(value).dementia.id}`)
