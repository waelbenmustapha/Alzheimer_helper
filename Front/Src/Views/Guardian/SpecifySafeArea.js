...
function saveSafeArea(){
  ...
  axios.post("http://192.168.8.100:8090/dementia/safezone/4028b8817f462f98017f4647f8dc0001",{latitude:marker.latitude.toFixed(7),longitude:marker.longitude.toFixed(7),diameter:radius})
}
