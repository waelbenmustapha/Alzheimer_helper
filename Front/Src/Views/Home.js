...
const Home = ({ navigation }) => {
  ...
  useEffect(() => {
    console.log(`http://172.16.18.122:8090/guardian/get`);
    axios.get(`http://172.16.18.122:8090/guardian/get`).then((res) => console.log(res)).catch((err) => console.log(err))
  }, [])
      ...
      <View style={{ flex: 9 }}>
        <View style={{ flexDirection: "row" }}>
          ...
          <View style={{ flex: 2 }} >
            ...
            <TouchableOpacity style={{ alignItems: "center" }}
          onPress={() => navigation.navigate("HistoryDemantia")}>
              <Image
                source={require("./../../assets/profile.png")}
                style={{
                  width: 150,
