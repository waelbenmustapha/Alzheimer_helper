...
const Contact = ({ navigation, route }) => {
    ...
    const updateContact = () => {
        console.log(edit)
        axios.put(`http://192.168.1.60:8090/contacts/edit/${edit}`,
    ...
    /*   function deleteContact(id) {
          console.log(id)
          axios.delete(`http://192.168.1.60:8090/contacts/delete/${id}`);
          alert("Successful contact deleted!");
      } */

    const deleteContact = () => {
        axios.delete(`http://192.168.1.60:8090/contacts/delete/${edit}`)
            .then(getData())
        getData();
    }
        ...
        AsyncStorage.getItem('user')
            .then(value => {
                ...
                if (JSON.parse(value).type) {
                    axios.post(`http://192.168.1.60:8090/contacts/add/${JSON.parse(value).dementia.id}`,
        ...
        AsyncStorage.getItem('user')
            .then(value => {
                ...
                if (JSON.parse(value).type == 'dementia') {
                    axios.get(`http://192.168.1.60:8090/contacts/get-contacts/${JSON.parse(value).id}`)
                        .then((res) => {
                    ...
                    axios.get(`http://192.168.1.60:8090/contacts/get-contacts/${JSON.parse(value).dementia.id}`)
                        .then((res) => {
                            setContact(res.data);
                            console.log(res.data)
                        })
