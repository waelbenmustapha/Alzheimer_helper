...
const FChangePassword = () => {
    ...
    const submitChangePassword = async () => {
        ...
        console.log(`http://192.168.1.19:8090/auth/change-password/${email}`)
        console.log(`http://192.168.1.19:8090/auth/change-password/${password}`)
        axios.put(`http://192.168.1.19:8090/auth/change-password/${email}`,
        password,{headers:{ 
