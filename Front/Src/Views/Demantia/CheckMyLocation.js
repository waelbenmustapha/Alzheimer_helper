...
const CheckMyLocation = () => {
  ...
  function postLocation(latitude,longitude){
    ...
    console.log("**********************************")
    axios.post(`http:/172.16.18.122:8090/demantia/post-location/4028b8817f092fe7017f0931962d0001/${latitude.toFixed(7)}/${longitude.toFixed(7)}`).then((res)=>console.log(res.data)).catch((err)=>console.log("ell error"+err))
  }
